...
# Remove unnecessary explicit raster-resampling property. MapLibre defaults to linear;
# keeping the layer minimal reduces version/property compatibility risk.
p=Path('pad-grade/v119-dev.js')
js=p.read_text().replace(",'raster-resampling':'linear'",'')
p.write_text(js)
