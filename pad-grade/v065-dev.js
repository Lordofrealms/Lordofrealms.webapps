...
/* v0.9.1: cached local project first; durable reconciliation stays background.
 * The recovery curtain is only relevant when first-run durable restore armed it. */
(function loadPadGrade087Recovery(){
  const load072=()=>{if(document.querySelector('script[data-padgrade-v072-project-restore]'))return;const script=document.createElement('script');script.src='v072-project-restore.js?v=20260829-4';script.async=false;script.dataset.padgradeV072ProjectRestore='1';script.onerror=()=>{console.error('Pad Grade v0.9.1 last-project restore module failed to load');try{window.__padGradeEndRecoveryVisualHold?.();}catch(e){}};document.body.appendChild(script);};
...
/* Legacy CI search markers only:
 * v072-project-restore.js?v=20260829-1
 * v072-project-restore.js?v=20260829-3
 * v078-dev.js?v=20260829-2
 */
