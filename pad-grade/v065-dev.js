 ...
 * They waited 45/60 seconds for SAF indexing and then reloaded the page. */
(function loadPadGrade087Recovery(){
  const load072=()=>{if(document.querySelector('script[data-padgrade-v072-project-restore]'))return;const script=document.createElement('script');script.src='v072-project-restore.js?v=20260829-2';script.async=false;script.dataset.padgradeV072ProjectRestore='1';script.onerror=()=>{console.error('Pad Grade v0.8.7 last-project restore module failed to load');try{window.__padGradeEndRecoveryVisualHold?.();}catch(e){}};document.body.appendChild(script);};
