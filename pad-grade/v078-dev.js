...
(function installPadGrade079(){
  'use strict';
  const VERSION='v0.8.9 DEV',MODEL='locality-triangle-local-rectangle-idw2-edge-locked-one-sixth-depth',SURFACE_NEW='surface-local-v078.js?v=20260826-2',WORKER_MATCH=/heatmap-raster-worker-v0(?:73|76|77|78)\.js(?:\?|$)/,WORKER_NEW='heatmap-raster-worker-v078.js?v=20260826-3';
