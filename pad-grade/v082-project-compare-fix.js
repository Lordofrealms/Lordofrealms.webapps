...
(function waitForPadGrade082ProjectComparison(){
  'use strict';
  ...
  function start(){
    ...
    if(!core||typeof core.comparisonEligibility!=='function'){
      if(attempts++<120){setTimeout(start,100);return;}
      console.error('Pad Grade v0.8.2 comparison fix could not find the updated comparison core');
      return;
    }
    if(window.__padGradeComparisonFix082Installed)return;
    window.__padGradeComparisonFix082Installed=true;
    install(core);
  }
