/* Pad Grade v0.7.6 DEV — local-triangle IDW² raster worker.
 *
 * Each raster sample uses only the smallest-area measured triangle that contains
 * that sample. Equal minimum-area triangles are evaluated independently and their
 * results are averaged. The shared surface module is also used by the map probe
 * and earthwork/target calculations on the main thread.
 */
'use strict';
importScripts('surface-local-v076.js?v=20260826-1');
